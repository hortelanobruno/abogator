...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleCuatro.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleCuatro.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamodulecuatro())
			{
				...
				redirect(SITE_AREA .'/content/pruebamodulecuatro');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleCuatro.Content.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleCuatro.Content.Delete');
