...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleCuatro.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleCuatro.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamodulecuatro())
			{
				...
				redirect(SITE_AREA .'/reports/pruebamodulecuatro');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleCuatro.Reports.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleCuatro.Reports.Delete');
