...
class contextprueba extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleDos.Contextprueba.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleDos.Contextprueba.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduledos())
			{
				...
				redirect(SITE_AREA .'/contextprueba/pruebamoduledos');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleDos.Contextprueba.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleDos.Contextprueba.Delete');
