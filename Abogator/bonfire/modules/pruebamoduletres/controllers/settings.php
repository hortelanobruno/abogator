...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleTres.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleTres.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduletres())
			{
				...
				redirect(SITE_AREA .'/settings/pruebamoduletres');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleTres.Settings.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleTres.Settings.Delete');
