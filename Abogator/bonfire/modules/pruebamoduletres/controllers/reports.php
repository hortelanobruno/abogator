...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleTres.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleTres.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduletres())
			{
				...
				redirect(SITE_AREA .'/reports/pruebamoduletres');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleTres.Reports.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleTres.Reports.Delete');
