...
class contextprueba extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Noticias.Contextprueba.View');
	...
	*/
	...
	{
		$this->auth->restrict('Noticias.Contextprueba.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_noticias())
			{
				...
				redirect(SITE_AREA .'/contextprueba/noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Noticias.Contextprueba.Edit');
		...
		{
			$this->auth->restrict('Noticias.Contextprueba.Delete');
