...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/reports/info_noticias', lang('info_noticias_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Info_Noticias.Reports.Delete')) : ?>
