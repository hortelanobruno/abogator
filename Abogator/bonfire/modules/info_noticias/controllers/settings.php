...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Info_Noticias.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Info_Noticias.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_info_noticias())
			{
				...
				redirect(SITE_AREA .'/settings/info_noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Info_Noticias.Settings.Edit');
		...
		{
			$this->auth->restrict('Info_Noticias.Settings.Delete');
