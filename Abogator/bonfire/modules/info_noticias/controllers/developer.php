...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Info_Noticias.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Info_Noticias.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_info_noticias())
			{
				...
				redirect(SITE_AREA .'/developer/info_noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Info_Noticias.Developer.Edit');
		...
		{
			$this->auth->restrict('Info_Noticias.Developer.Delete');
