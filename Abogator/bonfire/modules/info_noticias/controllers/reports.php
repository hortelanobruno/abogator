...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Info_Noticias.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Info_Noticias.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_info_noticias())
			{
				...
				redirect(SITE_AREA .'/reports/info_noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Info_Noticias.Reports.Edit');
		...
		{
			$this->auth->restrict('Info_Noticias.Reports.Delete');
