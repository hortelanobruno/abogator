...
class contextprueba extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Info_Noticias.Contextprueba.View');
	...
	*/
	...
	{
		$this->auth->restrict('Info_Noticias.Contextprueba.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_info_noticias())
			{
				...
				redirect(SITE_AREA .'/contextprueba/info_noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Info_Noticias.Contextprueba.Edit');
		...
		{
			$this->auth->restrict('Info_Noticias.Contextprueba.Delete');
