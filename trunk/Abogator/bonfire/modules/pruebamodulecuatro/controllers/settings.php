...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleCuatro.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleCuatro.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamodulecuatro())
			{
				...
				redirect(SITE_AREA .'/settings/pruebamodulecuatro');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleCuatro.Settings.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleCuatro.Settings.Delete');
