...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleCuatro.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleCuatro.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamodulecuatro())
			{
				...
				redirect(SITE_AREA .'/developer/pruebamodulecuatro');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleCuatro.Developer.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleCuatro.Developer.Delete');
