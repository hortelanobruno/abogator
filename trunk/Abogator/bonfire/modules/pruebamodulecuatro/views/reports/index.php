<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('PruebaModuleCuatro.Reports.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('PruebaModuleCuatro.Reports.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/reports/pruebamodulecuatro/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->pruebamodulecuatro_coluno) ?></td>
				<?php else: ?>
