<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Info_Noticias.Content.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Info_Noticias.Content.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/content/info_noticias/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->titulo) ?></td>
				<?php else: ?>
