...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Noticias.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Noticias.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_noticias())
			{
				...
				redirect(SITE_AREA .'/reports/noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Noticias.Reports.Edit');
		...
		{
			$this->auth->restrict('Noticias.Reports.Delete');
