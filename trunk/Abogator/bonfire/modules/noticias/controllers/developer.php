...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Noticias.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Noticias.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_noticias())
			{
				...
				redirect(SITE_AREA .'/developer/noticias');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Noticias.Developer.Edit');
		...
		{
			$this->auth->restrict('Noticias.Developer.Delete');
