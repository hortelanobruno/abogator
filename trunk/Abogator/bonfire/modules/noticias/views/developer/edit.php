...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/developer/noticias', lang('noticias_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Noticias.Developer.Delete')) : ?>

            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('noticias_delete_confirm'); ?>')">
