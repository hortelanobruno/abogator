...
class contextprueba extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleTres.Contextprueba.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleTres.Contextprueba.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduletres())
			{
				...
				redirect(SITE_AREA .'/contextprueba/pruebamoduletres');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleTres.Contextprueba.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleTres.Contextprueba.Delete');
