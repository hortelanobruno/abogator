...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleTres.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleTres.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduletres())
			{
				...
				redirect(SITE_AREA .'/developer/pruebamoduletres');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleTres.Developer.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleTres.Developer.Delete');
