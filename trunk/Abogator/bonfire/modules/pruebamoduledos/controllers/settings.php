...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleDos.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleDos.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduledos())
			{
				...
				redirect(SITE_AREA .'/settings/pruebamoduledos');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleDos.Settings.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleDos.Settings.Delete');
