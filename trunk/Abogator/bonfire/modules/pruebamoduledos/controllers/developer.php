...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleDos.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleDos.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduledos())
			{
				...
				redirect(SITE_AREA .'/developer/pruebamoduledos');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleDos.Developer.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleDos.Developer.Delete');
