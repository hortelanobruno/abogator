...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('PruebaModuleDos.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('PruebaModuleDos.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_pruebamoduledos())
			{
				...
				redirect(SITE_AREA .'/reports/pruebamoduledos');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('PruebaModuleDos.Reports.Edit');
		...
		{
			$this->auth->restrict('PruebaModuleDos.Reports.Delete');
